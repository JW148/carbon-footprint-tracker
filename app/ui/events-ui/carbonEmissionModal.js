...
export default function CarbonEmissionModal({ isOpen, onOpenChange, eventData }) {
  ...
  return (
    <>
      <Modal isOpen={isOpen} size={size} onOpenChange={onOpenChange} placement="top-center">
        <ModalContent>
          {(onClose) => (
            ...
            <form action={carbonEvent}>
              <>
                <ModalHeader className="flex flex-col gap-4">
                    MDC Carbon Footprint Survey - This weeks' run: {eventData.date}
                </ModalHeader>
                <ModalBody>
                    ...
                    <Input
                        ...
                        startContent={
                        <div className="pointer-events-none flex items-center">
                            <span className="text-default-400 text-small">passengers</span>
                        </div>
                        }
                    />
